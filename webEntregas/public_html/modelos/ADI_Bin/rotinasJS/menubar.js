...
function showMenu(m_No, eventObj) {
	...
	if (menuType[m_No] != 'blank') {
		...
		// TODO: ver modo de alinhar o submenu exatamente abaixo do menu.
		//moveXY('menu' + m_No, x, y);
		moveXY('menu' + m_No, 0, y);
