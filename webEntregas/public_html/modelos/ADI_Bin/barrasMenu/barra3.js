<!-- /ADI_Intranet_Root/ADI_Programacao/ADI_Bin/barrasMenu/barra3.js -->
    <STYLE TYPE=text/css>
...
var larguraTela = screen.width;
    ...
    function preparaTabela() {
        altura = defineAltura();
        largura = defineLargura();    
    }   
    
//desenha a tabela que envolve todo o menu
function desenhaTabela(siglaDoSistema,nomeSistema ,nomeRealSistema)
{
    linha = "<BR><BR>";                       
    desenhaInicioTabela(siglaDoSistema, nomeSistema, nomeRealSistema, altura, largura);
    document.writeln(linha);
    desenhaFinalTabela(siglaDoSistema, nomeSistema, nomeRealSistema, altura, largura);       
}
...
function desenhaInicioTabela(siglaDoSistema, nomeSistema,nomeRealSistema, altura, largura) {
    ...
    if(nomeRealSistema == "ADI_ControleDeProjetos" || nomeRealSistema == "ADI_HelpDesk" || nomeRealSistema == "ADI_LicencaSistema" || nomeRealSistema == "ADI_GerenciaDeTelas" || nomeRealSistema == "ADI_DamAnual" || nomeRealSistema == "ADI_AtualizacaoDeSistema" || nomeRealSistema == "ADI_Implantacao" || nomeRealSistema == "ADI_Conversao" || nomeRealSistema == "ADI_ControleDeViagens" ) {
        texto += "<tr><td height=15 background='/ADI_Intranet_Root/"+ nomeRealSistema +"/bin/imagens/barraCor.jpg'><center><font size=2 face='Helvetica'>"+nome+"</td></tr>";
    } else if (nomeRealSistema == "segurancaIntranet"){
	    		texto += "<tr><td height=15 background='/ADI_Intranet_Root/ADI_Intranet/package/"+nomeRealSistema+"/bin/imagens/barraCor.jpg'><center><font size=2 face='Helvetica'>"+ nome +"</td></tr>";
               }else {
                      texto += "<tr><td height=15 background='/ADI_Intranet_Root/ADI_Programacao/ADI_MaxNetADI/package/"+ nomeRealSistema +"/bin/imagens/barraCor.jpg'><center><font size=2 face='Helvetica'>"+ nome +"</td></tr>";
                     }
...
function desenhaFinalTabela(siglaDoSistema, nomeSistema,nomeRealSistema, altura, largura, versao) {
    ...
    texto += "</td></tr>";
    if(nomeRealSistema == "ADI_ControleDeProjetos" || nomeRealSistema == "ADI_HelpDesk" || nomeRealSistema == "ADI_LicencaSistema" || nomeRealSistema == "ADI_GerenciaDeTelas"  || nomeRealSistema == "ADI_DamAnual" || nomeRealSistema == "ADI_AtualizacaoDeSistema" || nomeRealSistema == "ADI_Implantacao" || nomeRealSistema == "ADI_Conversao" || nomeRealSistema == "ADI_ControleDeViagens"  ) {
        texto += "<tr><td height=15 align='right' background='/ADI_Intranet_Root/"+nomeRealSistema+"/bin/imagens/barraCor.jpg'><font size=1 face='Helvetica'>v" + versao + "&nbsp;</td></Tr>";
    } else if (nomeRealSistema == "segurancaIntranet"){
